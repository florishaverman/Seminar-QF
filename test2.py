...
simulated_cashflows, simulated_interest_rates = hq.generate_multiple_cashflows(data, current_euribor, prepayment_model, 1.5, 0.2633, 100, 120, 2)
#desired_cashflows = ofm.Compute_Cash_Flows(data)
desired_value = ofm.Compute_Time_Values(data)
